...
Start with your program from Exercise 4-1 (page 60). Make a copy of the list of
...
pizzas = ["Four Cheese Pizza", "Mushroom Pizza", "Hawaiian Pizza"]

friend_pizzas = pizzas[:]

pizzas.append("BBQ Chicken Pizza")

friend_pizzas.append("Veggie's Delight Pizza")
