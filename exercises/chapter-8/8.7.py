...
it should return a dictionary containing these two pieces of information. Use 
...
value for the number of tracks, add that value to the album’s dictionary. Make 
...
print(make_album("Rihanna", "Big Girls Don't Cry"))
print(make_album("Kanye West", "The Life Of Pablo", 9))
